...
Ce programme de test est sensé vérifier le bon fonctionnement du code lié à  la contrainte principale, qui est le calcul de Monte-Carlo avec paradigme de programmation parallèle master/worker.
